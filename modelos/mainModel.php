...
class mainModel
{
    ...
    /* ---------------- Funciones ejecutar consultas simples---------------- */
    ...
    {
        $valores = explode("-", $fecha); /* separa string por guion */
    ...
    protected static function paginador_tablas($pagina, $Npaginas, $url, $botones)
    {
        ...
        if ($pagina == 1) {
            $tabla .= ' <li class="page-item disabled page-item"><a class="page-link"><i class="fas fa-angle-double-left"></i></a></li>';
        } else {
            $tabla .= ' <li class="page-item"><a class="page-link" href="' . $url . '/1"></a></li>
